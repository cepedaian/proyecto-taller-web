...
<section class="container p-3">
	...
	<form:form action="insertar-usuario" method="POST" modelAttribute="usuario">
		...
		<div class="form-group row">
			<label for="password" class="col-sm-2 col-form-label col-form-label-sm font-weight-bold">Contrase�a:</label>
			<div class="col-sm-10">
				<form:input path="password" type="password" class="form-control form-control-sm" id="password" placeholder="Ingrese su Contrase�a"/>
			</div>
		</div>
		<div class="form-group row">
